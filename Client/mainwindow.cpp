...
void MainWindow::on_loginButton_clicked()
{
   ...
   if (read(MainWindow::sv_sock, &len, 4) <= 0)
   {
      QMessageBox::information(this, "Ceva nu e bine!", "Conectiunea la server a fost pierduta! (" + QString(strerror(errno)) + ")");
      ::close(sv_sock);
      ui->stackedWidget->setCurrentWidget(ui->connectToServerPage);
...
void MainWindow::on_registerButton_clicked()
{
   ...
   {
      QMessageBox::information(this, "Parola nu se potriveste", "Parola din casuta text de confirmare nu se potriveste cu parola scrisa prima data!");
      return;
   }
